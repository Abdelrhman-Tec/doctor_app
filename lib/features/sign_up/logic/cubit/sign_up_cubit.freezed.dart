...
/// @nodoc
mixin _$SignUpState<T> implements DiagnosticableTreeMixin {
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'SignUpState<$T>'))
    ;
}
...
class _Initial<T> with DiagnosticableTreeMixin implements SignUpState<T> {
  const _Initial();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'SignUpState<$T>.initial'))
    ;
}
...
class Loading<T> with DiagnosticableTreeMixin implements SignUpState<T> {
  const Loading();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'SignUpState<$T>.loading'))
    ;
}
...
class Success<T> with DiagnosticableTreeMixin implements SignUpState<T> {
...
class Error<T> with DiagnosticableTreeMixin implements SignUpState<T> {
